...
import com.brandoncano.inductancecalculator.data.ThemePreferences
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    init {
        val themePreference =
            ThemePreferences.THEME_PREFERENCE.loadIntData(application)
        _themeMode.value = ThemeMode.Companion.fromValue(themePreference)
    }
